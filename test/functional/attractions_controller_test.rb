...
class AttractionsControllerTest < ActionController::TestCase
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post :create, attraction: { latitude: @attraction.latitude, longitude: @attraction.longitude, name: @attraction.name }
    end
  ...
  test "should update attraction" do
    put :update, id: @attraction, attraction: { latitude: @attraction.latitude, longitude: @attraction.longitude, name: @attraction.name }
    assert_redirected_to attraction_path(assigns(:attraction))
  end
